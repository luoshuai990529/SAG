...
const deliveryApi = `963e10c3777e15c8d0764a2747d044fa.d.1ms.run/zleap-ai/sag-api@${digestA}`;
const deliveryWeb = `963e10c3777e15c8d0764a2747d044fa.d.1ms.run/zleap-ai/sag-web@${digestB}`;
const deliveryGateway = `963e10c3777e15c8d0764a2747d044fa.d.1ms.run/zleap-ai/sag-gateway@sha256:${"c".repeat(64)}`;
